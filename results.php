...
// Fetch election record (assuming a single election setup)
$sql = "SELECT * FROM elections LIMIT 1";
$result = $conn->query($sql);

if (!$result || $result->num_rows == 0) {
    // No election found, redirect to home
...
// ✅ Check if results are not released
if ((int)$election['release_results'] === 0) {
  $_SESSION['error'] = "Election results are not released yet.";
