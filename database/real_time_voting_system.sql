...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2026 at 07:10 PM
...
--
-- Database: `real_time_voting_system`
--
...
(1, 'jeremie', 'jeremie01@gmail.com', '$2y$10$jkjhOn.19mEYm2bMzDEwLe.4CYAPGK0wiKrJPOLc4JGfpxZbF/zOu', 'Jeremie', 'KAMBALE LUSENGE', 'superadmin', 'profile.png', '2025-04-02', NULL);
...
(2, 'evliCGW3k4fQpmP', '$2y$10$jkjhOn.19mEYm2bMzDEwLe.4CYAPGK0wiKrJPOLc4JGfpxZbF/zOu', 'John', 'Kato', 'download.png', NULL);
